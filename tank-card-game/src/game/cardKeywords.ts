  ...
  switch (card.class) {
    ...
    case "armored_car":
      return {
        ...
        body: "Быстрый разведчик с лёгкой бронёй. Ходит до 3 клеток по прямой или 2 по диагонали. С фронта бьёт слабее, с фланга и тыла — сильнее. По тылу и штабу может атаковать дважды за ход.",
      };
    default:
      return {
        id: "type",
