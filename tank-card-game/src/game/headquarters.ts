...
export const HEADQUARTERS: Record<HeadquartersId, HeadquartersDefinition> = {
  ...
  first_panzer_division: {
    ...
    description:
      "Танковый клин: первый танк, разыгранный за ход, получает «Блиц» — два перемещения в ход выхода на поле.",
    ability: {
      name: "Танковый клин",
      firstTankBlitz: true,
    },
  ...
  soviet_motor_rifle_division: {
    ...
    type: "Мотопехотный штаб",
    description:
      "Быстрая переброска: лёгкие юниты получают «Блиц» — два перемещения в ход выхода на поле.",
    ability: {
